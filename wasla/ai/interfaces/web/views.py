...
from ai.application.use_cases.apply_category import ApplyCategoryCommand, ApplyCategoryUseCase
from ai.application.use_cases.categorize_product import (
    CategorizeProductCommand,
    CategorizeProductUseCase,
)
from ai.application.use_cases.generate_description import (
...
def ai_visual_search(request: HttpRequest) -> HttpResponse:
    ...
    if request.method == "POST":
        ...
        return render(request, "dashboard/ai/visual_search.html", {"result": result})
    return render(request, "dashboard/ai/visual_search.html", {"result": None})
