...
from ai.domain.policies import validate_image_upload
from ai.domain.types import SearchResult
from ai.infrastructure.embeddings.vector_store import search_similar, upsert_embedding
...
def _ensure_embeddings(store_id: int, provider_code: str, limit: int = 200) -> None:
    ...
    """
    from ai.infrastructure.embeddings.vector_store_faiss import is_available as faiss_available, build_index as faiss_build_index
