...
PERMISSIONS = [
    ...
    ("plugins.manage_registry", "plugins", "Manage plugin registration records"),
    ("plugins.manage_scopes", "plugins", "Manage plugin permission scopes"),
    ("plugins.manage_event_subscriptions", "plugins", "Manage plugin event subscriptions"),
